    ...
    return (
        ...
        <nav className="nav sticky" style={{
          ...
          opacity: scrollState === "top" ? "100%" : "90%"
            ...
            <a href="https://makennamartin97.github.io/project-for-dardan/"><img src={logo} className="navlogo" alt="logo"/></a>
            </div>
            ...
            <ul className={click ? "nav-options active" : "nav-options"}>
                ...
                <li className="option" onClick={closeMobileMenu}>
                  <a href="https://makennamartin97.github.io/project-for-dardan/">Home</a>
                </li>
                <li className="option" onClick={closeMobileMenu}>
